...
drafting_task_instagram = Task(
    description=(
        "Generate a draft for an Instagram caption on {topic}. "
        "Focus on creating content that is visually appealing, engaging, and aligns with current trends or developments in {topic}."
    ),
    expected_output=(
        "A compelling draft Instagram caption on {topic}, capturing the essence of {topic} and resonating with Instagram users."
    ),
    agent=instagram_drafting_agent,
)

refinement_seo_task_instagram = Task(
    description=(
        "Refine and polish a draft Instagram caption on {topic}. "
        "Focus on enhancing grammar, clarity, and overall readability while ensuring alignment with the intended style and engagement goals. "
        "Incorporate relevant emojis tastefully. Additionally, optimize the caption for discoverability and engagement by identifying and integrating "
        "relevant keywords and hashtags to improve visibility on Instagram's platform."
    ),
    expected_output=(
        "A polished and SEO-optimized Instagram caption on {topic}, improved in grammar, clarity, and readability. "
        "The caption effectively communicates the intended message while maintaining a style that resonates with Instagram users. "
        "It is enhanced with relevant keywords and hashtags, structured to maximize discoverability and engagement, appealing to the target audience effectively."
    ),
    agent=instagram_refinement_seo_agent,
)
